...
HD_PWD='D:/xilinx/xup/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log functionF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source functionF.tcl -notrace
