...
HD_PWD='D:/xilinx/xup/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log functionF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source functionF.tcl
