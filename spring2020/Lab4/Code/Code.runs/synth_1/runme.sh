...
HD_PWD='D:/xilinx/xup/Lab_4/Lab_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multifunctionRegister.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multifunctionRegister.tcl
