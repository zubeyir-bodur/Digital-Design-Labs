...
HD_PWD='D:/xilinx/xup/Lab_5/Lab_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficLightController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trafficLightController.tcl
