...
HD_PWD='D:/xilinx/xup/Lab_5/Lab_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficLightController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trafficLightController.tcl -notrace
