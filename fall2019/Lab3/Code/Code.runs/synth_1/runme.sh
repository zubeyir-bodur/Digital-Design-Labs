...
HD_PWD='D:/xilinx/xup/Lab-03/Lab-03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log functionFBasys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source functionFBasys.tcl
