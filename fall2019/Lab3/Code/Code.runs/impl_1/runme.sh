...
HD_PWD='D:/xilinx/xup/Lab-03/Lab-03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log functionFBasys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source functionFBasys.tcl -notrace
