...
HD_PWD='D:/xilinx/xup/Lab05/Lab05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log master_slave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source master_slave.tcl -notrace
