...
HD_PWD='D:/xilinx/xup/Lab05/Lab05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_slave.tcl
